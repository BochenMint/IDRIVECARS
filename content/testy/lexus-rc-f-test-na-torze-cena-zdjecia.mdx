...
status: published
lead: >-
  Lexus RC F ma jedną wielką zaletę oraz jedną wielką wadę. Zaletą jest
  5-litrowe, wolnossące V8. Wadą zaś porównywanie go do kosmicznie dobrego - jak
  twierdzą świadkowie jego możliwości - LFA, które chętnie podsuwa nam nawet
  Lexus...
originalUrl: 'https://autogaleria.pl/lexus-rc-f-test-na-torze-cena-zdjecia'
sourceUrl: 'https://autogaleria.pl/lexus-rc-f-test-na-torze-cena-zdjecia'
seoTitle: 'Lexus RC F - test na torze, cena, zdjęcia'
seoDescription: >-
  Lexus RC F ma jedną wielką zaletę oraz jedną wielką wadę. Zaletą jest
  5-litrowe, wolnossące V8. Wadą - porównania do genialnego i piorunującego
  LFA...
tags:
  - test
  - lexus
  ...
  - stig
brand: Lexus
model: 'RC F - test na torze, cena, zdjęcia'
year: 2015
galleryDir: galleries/lexus-rc-f-pierwsza-jazda
pros:
  - 5-litrowe wolnossące V8
  - Świetnie wykończone wnętrze
  - Obiecujące właściwości na torze
import:
  source: autogaleria
  importedAt: '2026-06-30T21:41:21.359Z'
  sourceId: lexus-rc-f-test-na-torze-cena-zdjecia
  sourceFile: >-
    content/import/autogaleria/articles/json/lexus-rc-f-test-na-torze-cena-zdjecia.json
---
...
Zaczął od prztyczka w wielki nos [Clarksona](/news/jeremy-clarkson-oficjalnie-zwolniony-z-bbc), mówiąc, że nie potrafił wcisnąć kilku przycisków w odpowiedniej kolejności, przez co samochód nie prowadził się, jak należy i nie pokazał, co naprawdę potrafi. No i wtedy się zaczęło.
...
Nie ma tu, podobnie jak np. w modelach RS 6 i RS 7 od Audi, systemu _launch control_. Między innymi dlatego pierwsze metry nie wywołują przerażenia, a narządy wewnętrzne pozostają na swoim miejscu. Dalej jest już znacznie lepiej, bo V8 zaczyna wykorzystywać wysokie obroty, a ciasno zestopniowana skrzynia biegów pozwala szybko zwiększać prędkość. **Efekt to 4,5 sekundy do 100 km/h. Bardzo dobrze. Maksymalnie rozpędza się do 270 km/h.**
