...
lead: "Volkswagen zaprezentował nową generację słynnego Transportera. Czy T6 zasługuje na cyferkę 6 w nazwie? Sprawdziliśmy to podczas pierwszych jazd testowych w Sztokholmie."
originalUrl: "https://autogaleria.pl/volkswagen-t6-500-shades-of-transporter"
tags: ["volkswagen", "test", "pierwsza-jazda", "transporter", "t6", "van"]
...
Polskie ceny nowego Volkswagena T6 Multivan nie są jeszcze znane, ale w Niemczech zaczynają się one od nieca­łych 30,000 Euro. Za najwyższą wersję wyposażeniową *Highline* z 204-konnym silnikiem TDI, napędem 4MOTION i skrzynią DSG przyjdzie nam zapłacić około 68,000 Euro.
