---
slug: "lexus-rc-f-test-na-torze-cena-zdjecia"
title: "Lexus RC F - test na torze, cena, zdjęcia"
publishedAt: "2015-04-30"
category: "Pierwsze jazdy"
author: "Marcin Bochenek"
sourceUrl: "https://autogaleria.pl/lexus-rc-f-test-na-torze-cena-zdjecia"
discoveredVia: "elasticsearch-author"
lead: "Lexus RC F ma jedną wielką zaletę oraz jedną wielką wadę. Zaletą jest 5-litrowe, wolnossące V8. Wadą zaś porównywanie go do kosmicznie dobrego - jak twierdzą świadkowie jego możliwości - LFA, które chętnie podsuwa nam nawet Lexus..."
tags: ["test", "lexus", "v8", "tor", "lexus rc f", "rc-f", "stig"]
---

Tor szkoleniowy w Bednarach koło Poznania, godzina 10:32. Przez szybkę kasku oglądam wnętrze [Lexusa RC F](http://www.autogaleria.pl/nowosci/nowosci-i-premiery/lexus-rc-f-niech-zyje-krol/), które jest nie do pomylenia z żadną inną marką. Świetnie wykończone, z dużym ekranem, wysokim tunelem środkowym i jednoznacznym podobieństwem do pozostałych modeli marki w wersjach F-Sport. Wyraźnie inne są tylko fotele, które poza tym, że fajnie wyglądają, to również są bardzo wygodne i dość dobrze trzymają na boki, choć nie są wystarczająco „głębokie” jak na możliwości samochodu. A te są obiecujące.
...
Zaczął od prztyczka w wielki nos [Clarksona](http://www.autogaleria.pl/nowosci/wiadomosci/jeremy-clarkson-oficjalnie-zwolniony-z-bbc/), mówiąc, że nie potrafił wcisnąć kilku przycisków w odpowiedniej kolejności, przez co samochód nie prowadził się, jak należy i nie pokazał, co naprawdę potrafi. No i wtedy się zaczęło.
...
Tryb _Sport_ włączony, kontrola trakcji wyłączona. Tylko ja, maszyna i mechanizm różnicowy z systemem _torque vectoring_, który zamiast przyhamowywać koło, gdy traci przyczepność, rzuca więcej momentu obrotowego na to, które ma lepsze możliwości przeniesienia go na asfalt. Żeby jeździć szybciej, rzecz jasna.

Nie ma tu, podobnie jak np. w modelach [RS 6](http://www.autogaleria.pl/pierwsze-jazdy/audi-rs-6-avant-superkombi/) i [RS 7](http://www.autogaleria.pl/pierwsze-jazdy/audi-rs-7-quattro-rakieta-v8/) od Audi, systemu _launch control_. Między innymi dlatego pierwsze metry nie wywołują przerażenia, a narządy wewnętrzne pozostają na swoim miejscu. Dalej jest już znacznie lepiej, bo V8 zaczyna wykorzystywać wysokie obroty, a ciasno zestopniowana skrzynia biegów pozwala szybko zwiększać prędkość. **Efekt to 4,5 sekundy do 100 km/h. Bardzo dobrze. Maksymalnie rozpędza się do 270 km/h.**
...
Wtedy najbardziej poczułem **masę własną wynoszącą 1765 kg**. Dla porównania, [BMW M4](http://www.autogaleria.pl/nowosci/producenci-i-rynek/bmw-m3-i-m4-coupe-debiutuja-w-polsce/) waży 1537 kg, a bardziej pasujące charakterem do Lexusa [Maserati GranTurismo Sport](http://www.autogaleria.pl/testy/maserati-granturismo-sport/) - 1780 kg, [Mercedes C63 AMG S](http://www.autogaleria.pl/nowosci/mercedes-amg-c-63-mniejszy-lecz-mocniejszy/) - 1725 kg, a topowy [Ford Mustang](http://www.autogaleria.pl/nowosci/producenci-i-rynek/nowy-ford-mustang-dostepny-za-148-400-zl/) - 1725 kg. RC F nie wypada więc źle „wśród swoich”, bo znacznie bliżej mu do Maserati czy Forda (prawdopodobnie) niż do M4.
...
Lexus RC F zdaje się mieć najbardziej kompletny zestaw zdolności z przytoczonych GT. Jego charakter nie jest nawet w połowie tak dynamiczny, jak sugeruje oznaczenie F czy reklamy, dlatego próba odnalezienia w nim [LFA](http://www.autogaleria.pl/nowosci/producenci-i-rynek/lexus-konczy-produkcje-lfa/) i torowej drapieżności doprowadzi nas do konkluzji, że samochód się nie udał. A jednak zapowiada się jako świetne, komfortowe i bogato wyposażone Gran Turismo z mocnym V8. Wierzę, że wszystkie jego zalety wyjdą na jaw w teście drogowym.
...
- wyjdą na jaw w teście drogowym.
- Tymczasem zapraszamy na naszą sesję zdjęciową wykonaną częściowo z.. Helikoptera. Nie było łatwo nadążyć za pomarańczowym Lexusem...